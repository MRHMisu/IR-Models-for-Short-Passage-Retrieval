...
public class BM25QueryProcessor {
    ...
    public static void main(String[] args) {
        ...
        String vsm_result_output = ConfigurationReader.getPropertyByName("BM25_Result_Output");
        ...
        for (Integer qid : queryID_query_pair.keySet()) {
            ...
            BM25Model bm25 = new BM25Model(irModel);
            List<RankedPassage> rankedPassage = bm25.executeBM25();
